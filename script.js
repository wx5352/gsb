...
const translations = {
    zh: {
        ...
        course_2_title: "2. AI 内容创作与直播带货入门",
        course_2_desc: "学习用 AI 辅助创作吸引人的内容，并掌握直播带货的基础知识。",
        course_2_audience: "想尝试创作",
        course_3_title: "3. 安全防骗与心态建设",
        course_3_desc: "快乐学习，安全第一。识别网络诈骗，保持积极健康的上网心态。",
        course_3_audience: "所有学员"
    },
    en: {
        ...
        course_2_title: "2. AI Content Creation and Live Commerce",
        course_2_desc: "Learn to create engaging content with AI and master the basics of live commerce.",
        course_2_audience: "Creators",
        course_3_title: "3. Safety & Mindset",
        course_3_desc: "Happy learning, safety first. Identify scams and maintain a healthy mindset.",
        course_3_audience: "Everyone"
    },
    ms: {
        ...
        course_2_title: "2. Penciptaan Kandungan AI & E-dagang Langsung",
        course_2_desc: "Belajar mencipta kandungan menarik dengan AI dan fahami asas live streaming.",
        course_2_audience: "Pencipta",
        course_3_title: "3. Keselamatan & Minda",
        course_3_desc: "Belajar dengan gembira dan selamat. Kenali penipuan dalam talian.",
        course_3_audience: "Semua"
    }
};

// 课程基础数据 (ID和缩略图是通用的，文本从翻译对象中获取)
const courseData = [
    { id: 1, thumbnail: "🤖", videoUrl: "video/1.mp4" },
    { id: 2, thumbnail: "🎥", videoUrl: "video/2.mp4" },
    { id: 3, thumbnail: "🛡️", videoUrl: "video/3.mp4" }
];
